...
所有视频不允许下载。网页已经为 video 添加 `controlsList="nodownload"`、`disablePictureInPicture`，并尽量禁用右键菜单。

部署前建议压缩视频文件，尤其是剧情片和较长混剪。单个视频尽量控制在几十 MB 内；不建议直接上传几百 MB 的原始导出文件，否则移动端加载会很慢。

二创混剪有 3 条视频，放在：

```text
assets/videos/fanedit-01.mp4
assets/videos/fanedit-02.mp4
assets/videos/fanedit-03.mp4
```

如需更稳定的预览封面，可以补充：

```text
assets/images/fanedit-01-cover.jpg
assets/images/fanedit-02-cover.jpg
assets/images/fanedit-03-cover.jpg
```

原创剧情片有 2 条：

```text
film-01.mp4 对应《Ditto-不能说的幻想秘密》
film-02.mp4 对应《陌生善意》
```
...
```text
assets/videos/film-01.mp4
assets/videos/film-02.mp4
assets/images/film-01-cover.jpg
assets/images/film-02-cover.jpg
```
